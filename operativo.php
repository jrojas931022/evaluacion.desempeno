        ...
        <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 "
            ...
            <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
                <ul class="navbar-nav">
                    ...
                    <?php  if (strlen(stristr($_SESSION["usuario_rol"],100))>0){
          ...
          <div class="container-fluid py-4">
            ...
            if(isset($_POST['enviar'])){
                ...
                $calificacionLetra=$_POST['letra'];
                    ...
                    $fileName = uniqid().'.png';
                    file_put_contents("./firmas_operativas/".$fileName, $fileData);

                    include ("config.php");

             $sql="INSERT INTO encuesta (`id_encuesta`, `idEmpleado`, `idEvaluador`, `fecha_evaluacion`, `Periodo_evaluar`, `fila_1`, `fila_2`, `fila_3`, `fila_4`, `fila_5`, `fila_6`, `fila_7`, `fila_8`, `fila_9`, `fila_10`, 
             `fila_11`, `fila_12`, `fila_13`, `fila_14`, `fila_15`, `fila_16`, `fila_17`, `fila_18`, `observ_1`, `observ_2`, `observ_3`, `observ_4`, `observ_5`, `observ_6`, `observ_7`, `observ_8`, `observ_9`, `observ_10`,
              `observ_11`, `observ_12`, `observ_13`, `observ_14`, `observ_15`, `observ_16`, `observ_17`, `observ_18`, `desempeno`, firma_empleado, calificacion_general, calificacionFinal) VALUE (NULL,
               '".$idEmpleado."',  '".$idEvaluador."', '".$fecha_evaluacion."', '".$Periodo_evaluar."', '".$fila1."', '".$fila2."', '".$fila3."', '".$fila4."', '".$fila5."', '".$fila6."', '".$fila7."', '".$fila8."', 
               '".$fila9."', '".$fila10."', '".$fila11."', '".$fila12."', '".$fila13."', '".$fila14."', '".$fila15."', '".$fila16."', '".$fila17."', '".$fila18."','".$observacion1."', '".$observacion2."', '".$observacion3."',
                '".$observacion4."', '".$observacion5."', '".$observacion6."', '".$observacion7."', '".$observacion8."', '".$observacion9."', '".$observacion10."', '".$observacion11."', '".$observacion12."', '".$observacion13."',
                 '".$observacion14."', '".$observacion15."', '".$observacion16."', '".$observacion17."', '".$observacion18."', '".$comentarios."', '".$fileName."', '".$calificacion_General."' , '".$calificacionLetra."')";
      ...
      <form id="form" action="<?=$_SERVER['PHP_SELF'];?>" method="post">
                            <div class="container-fluid py-3">
                                ...
                                <div class="col-12 mt-1">
                                        ...
                                        <h4 class="mb-1">Evaluacion de desempeño personal Operativo</h4>
                                            <br>
                                            <br>
                                        ...
                                        necesarios para luego enviar los resultados al proceso de Recursos Humanos.</h6><br>
...
$sql="SELECT * FROM empleado INNER JOIN evaluador ON empleado.idEvaluador = evaluador.id_evaluador WHERE id_empleado = '$id'  AND  empleado.tipo_personal = 'OPERATIVO'";
...
<input type="hidden" id="idEmpleado" name="idEmpleado" value=" <?php  echo  $idempleado ;?> ">
                                    ...
                                    <label for="floatingTextarea">1. PRÁCTICOS DEL PUESTO DE TRABAJO Ejecuta las operaciones
                                        de acuerdo a la experiencia adquirida.</label><br>
                                    ...
                                    <div class="col-sm-6 col-xl-4">
                                        <div class="bg-light rounded h-100 p-4">
                                            ...
                                            <div>
                                                ...
                                                <input type="number" class="monto form-control form-control-sm"
                                                    style="width : 100px; heigth : 20px" placeholder="" name="fila_1" id="fila_1"
                                    ...
                                    <label for="floatingTextarea">2. TEÓRICOS DEL PUESTO DE TRABAJO: Aplica los conceptos
                                        adquiridos para la ejecución de las operaciones asignadas.</label><br>
                                    <div class="col-sm-6 col-xl-4">
                                        <div class="bg-light rounded h-100 p-4">
                                    ...
                                    <label for="floatingTextarea">3. CALIDAD EN EL TRABAJO: Realizar su operación de acuerdo
                                        a los métodos establecidos, es decir,
                                        haciendo las cosas bien desde la primera vez. Es detallista e identifica con
                                        facilidad requerimientos
                                        para realizar su operación de acuerdo a los stánderes establecidos.</label>
                                    <div class="col-sm-6 col-xl-4">
                                        <div class="bg-light rounded h-100 p-4">
                                            ...
                                            <div>
                                                <span>(1.Bajo, 2.Regular, 3.Alto)</span>
                                                <input type="number" class="form-control form-control-sm monto"
                                                    style="width : 100px; heigth : 20px" placeholder="" name="fila_3" id="fila_3"
                                                    minlength="1" maxlength="1" size="20" min="1" max="3"  onchange="sumar(this.value);" required>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <label for="floatingTextarea">4. PRODUCTIVIDAD: Cumple con los objetivos de producción
                                        de acuerdo con los estándares establecidos,
                                        siempre va acompañada de la calidad..</label>
                                    ...
                                    <div class="col-sm-6 col-xl-4">
                                        <div class="bg-light rounded h-100 p-4">
                                            ...
                                            <div>
                                                <span>(1.Bajo, 2.Regular, 3.Alto)</span>
                                                <input type="number" class="form-control form-control-sm monto"
                                                    style="width : 100px; heigth : 20px" placeholder="" name="fila_4" id="fila_4"
                                                    minlength="1" maxlength="1" size="20" min="1" max="3"  onchange="sumar(this.value);" required>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <input class="form-control form-control-sm" type="text" placeholder="Observaciones"
                                        name="observ_4" maxlength="74"  value=" Su promedio de productividad es: <?php echo  $producto   ?>%" readonly required><br>

                                    <label for="floatingTextarea">5. PUNTUALIDAD: la persona cumple con los horarios
                                        establecidos por la empresa, se encuentra a la
                                        hora de inicio ya listo para comenzar a trabajar en su puesto de trabajo.</label>
                                    ...
                                    <label for="floatingTextarea">6. ORIENTACION A LOS RESULTADOS: capacidad de encaminar
                                    ...
                                    <label for="floatingTextarea">7. ADAPTABILIDAD AL CAMBIO: La persona ha demostrado capacidad para adaptarse a trabajar ensituaciones variadas o cambios de operación y métodos cuando surgen dificultades o cambios de la organización.</label>
                                    <div class="col-sm-6 col-xl-4">
                                        <div class="bg-light rounded h-100 p-4">
                                    ...
                                    <label for="floatingTextarea">8. ASISTENCIA: Evita ausentarse de manera injustificada al
                                        trabajo.</label><br>
                                    <div class="col-sm-6 col-xl-4">
                                        <div class="bg-light rounded h-100 p-4">
                                    ...
                                    <label for="floatingTextarea">9. AUTOCONTROL: Capacidad de mantener controladas las
                                    ...
                                    <label for="floatingTextarea">10. COMPROMISO CON LA ORGANIZACION: Compreder las
                                        carcaterísticas de la organización, alineando la
                                        conducta y la responsabilidad laboral con los valores, principios y objetivos de la
                                        misma.</label>
                                    ...
                                    <label for="floatingTextarea">11. CONFIANZA: permite creer En nosotros mismos Y en los
                                        demás. Brinda seguridad. exigencia.</label>
                                    ...
                                    <label for="floatingTextarea">12. CONSTANCIA: ayuda a alcanzar cualquier meta, para ello
                                        debemos poner todo nuestro ánimo, Firmeza y perseverancia. Esperamos gente líder en
                                        nuestra empresa con gran firmeza Interior.</label>
                                    <div class="col-sm-6 col-xl-4">
                                        <div class="bg-light rounded h-100 p-4">
                                    ...
                                    <label for="floatingTextarea">13. COOPERACION: invita a compartir Con los demás tareas o
                                        actividades para alcanzar un fin común. Ayuda a lograr grandes metas y crecer
                                        juntos.</label>
                                    <div class="col-sm-6 col-xl-4">
                                        <div class="bg-light rounded h-100 p-4">
                                    ...
                                    <label for="floatingTextarea">14. DISCIPLINA: cumple las reglas que la empresa ha
                                    ...
                                    <label for="floatingTextarea">15. HONESTIDAD: invita a pensar, hablar y actuar siempre
                                        con la verdad. Fortalece nuestra relación yhace posible la calidad de nuestro
                                    ...
                                    <input class="form-control form-control-sm" type="text" placeholder="Observaciones"
                                        name="observ_15"  maxlength="74"   onchange="sumar(this.value);" required><br>


                                    <label for="floatingTextarea">16. RELACIONES INTERPERSONALES: Capacidad de la persona
                                        por promover, establecer y mantener relaciones cordiales reciprocas.</label>
                                    <div class="col-sm-6 col-xl-4">
                                        <div class="bg-light rounded h-100 p-4">
                                    ...
                                    <label for="floatingTextarea">17. RESPONSABILIDAD: permite trabajar en armonía, crea
                                        compromiso en los empleados y genera grandes colaboradores. </label>
                                    <div class="col-sm-6 col-xl-4">
                                        <div class="bg-light rounded h-100 p-4">
                                    ...
                                    <label for="floatingTextarea">18. TOLERANCIA A LA PRESION: Es la capacidad para
                                        responder y trabajar con alto desempeño ensituaciones de mucha exigencia.</label>
                                    <div class="col-sm-6 col-xl-4">
                                        <div class="bg-light rounded h-100 p-4">
    ...
    <br>
                                                <!-- Contenedor y Elemento Canvas -->
                                                    <div id="signature-pad" class="signature-pad" >
                                                        ...
                                                        <canvas style="width: 280px; height: 250px; border: 1px black solid; " id="canvas"></canvas>
                                                        </div>
                                                    </div>
                                                ...
                                                <input type="submit"  class="btn btn-sm btn-primary" name="enviar" value="FINALIZAR">
                                            </div>
                                        </div>
                                    </div>
                                    <?php
              ...
              <div class="row align-items-center justify-content-lg-between">
                <div class="col-lg-6 mb-lg-0 mb-4">
                  <div class="copyright text-center text-sm text-muted text-lg-start">
                    ...
                    <a href="https://www.franciscorocha.com" class="font-weight-bold" target="_blank">Confeccion Trajes S.A</a>
                  </div>
                </div>
              </div>
            </div>
