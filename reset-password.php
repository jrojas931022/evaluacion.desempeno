...
$sql = "UPDATE evaluador SET contrasena = '$nueva_contrasena' WHERE id_evaluador = '$usuario_id'";
...
<!-- Aqui solo aparece este <li> si el usuario es "usuario_admi", el codigo se interpreta como "si la variable session usuario es igual a usuario_admi muestrale esto" -->
  ...
  <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg ">
      ...
      <div class="container-fluid py-1 px-3">
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
            ...
            <li class="breadcrumb-item text-sm text-dark active" aria-current="page">Cambiar contraseña</li>
          </ol>
        </nav>
      ...
      <div class="col-12 mt-4">
          <div class="card mb-4">
            <div class="card-header pb-0 p-3">
              <h6 class="mb-1">Cambia tu contraseña</h6>
              <p class="text-sm">Complete este formulario para restablecer su contraseña.</p>
            </div>
    ...
    <br>
    <input type="password" class="form-control form-control-sm" name="nueva_contrasena" required>

    <br><br >

    <button type="submit"  class="btn btn-sm btn-primary">Cambiar Contraseña</button>
</form>
