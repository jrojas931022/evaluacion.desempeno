...
$columns = ['encuesta.id_encuesta', 'evaluador.id_evaluador', 'empleado.idEvaluador', 'empleado.id_empleado', 'empleado.numero_cedula', 'empleado.nombre', 'empleado.cargo', 'empleado.proceso', 'empleado.fecha_ingreso', 'encuesta.calificacionFinal' , 'empleado.tipo_personal'];   
 ...
 $personal=$row['tipo_personal'];
        ...
        if($personal == 'ADMINISTRATIVO'){
         $output['data'] .= '<td><p align="center"><a  target="_blank" class="btn btn-sm btn-primary" href="evaluacion_administrativa.php?id='.$row['id_encuesta'].'">Ver</a></P></td>';
             ...
             $output['data'] .= '<td><p align="center"><a  target="_blank" class="btn btn-sm btn-primary" href="evaluacion_operativa.php?id='.$row['id_encuesta'].'">Ver</a></P></td>';
        }
