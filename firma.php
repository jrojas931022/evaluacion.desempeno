  ...
  <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 " id="sidenav-main">
    ...
    <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
      <ul class="navbar-nav">
        ...
        <?php if (!empty($_SESSION["usuario_firma"])) {  ?>
          <li class="nav-item">
    ...
    <div id="page-meta" class="container">
      ...
      <div class="slogan">
        ...
        if (isset($_POST['enviar'])) {
          ...
          // Recibir datos del formulario de salida
          $documento_identidad = $_POST['Numero_cedula'];
          ...
          $sql = "UPDATE evaluador SET firma  ='$fileName' WHERE Numero_cedula = '$documento_identidad'";
         ...
         alert('Se Guardo la Firma de Manera Correcta  ');
        ...
        ?>
          ...
          <form id="form" action="<?= $_SERVER['PHP_SELF']; ?>" method="post">
            ...
            <br>
            <br>
            <h4>Digita tu firma:</h4>
            <input type="hidden" name="Numero_cedula" value="<?php echo $_SESSION["usuario_cedula"] ?>" style="border: 1px solid #000000; padding: 2px; border-radius: 3px; " required>
