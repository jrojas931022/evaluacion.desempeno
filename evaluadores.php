        ...
        <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
            <ul class="navbar-nav">
                ...
                if (strlen(stristr($rol, 100)) > 0) {
                    echo
                        ' <li class="nav-item">
                    <a class="nav-link active " href="evaluadores.php">
                        <div
                            class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
            ...
            <div class="container-fluid py-1 px-3">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
                        ...
                        <li class="breadcrumb-item text-sm text-dark active" aria-current="page">Resultados Generales
                        </li>
                    </ol>
                </nav>
        ...
        <main>
            <div class="container py-4 text-center">
                ...
                <div class="row g-4">
                    ...
                    <div class="col-auto">
                        <label for="num_registros" class="col-form-label">Número de filas: </label>
                    </div>
                    ...
                    <div class="col-auto">
                        <label for="num_registros" class="col-form-label"
                            style="display:block;text-align: right; margin-bottom: 5px;">Buscar : </label>
                    </div>
                    <div class="col-auto">
                ...
                <div class="row py-4">
                    <div class="col">
                        <table class="table-container">
                            <thead>
                                <th class="sort asc">
                                    <p align="center" style="font-weight: bold">Id
                                </th>
                                <th class="sort asc">
                                    <p align="center" style="font-weight: bold">Numero de Documento
                                </th>
                                <th class="sort asc">
                                    <p align="center" style="font-weight: bold">Nombre
                                </th>
                                <th class="sort asc">
                                    <p align="center" style="font-weight: bold">Cargo
                                </th>
                                <th class="sort asc">
                                    <p align="center" style="font-weight: bold">Proceso
                                </th>
                                <th class="sort asc">
                                    <p align="center" style="font-weight: bold">Fecha de Ingreso
                                </th>
                                <th class="sort asc">
                                    <p align="center" style="font-weight: bold">Tipo de Personal
                                </th>
                                <th class="sort asc">
                                    <p align="center" style="font-weight: bold">Periodo Evaluado
                                </th>
                                <th class="sort asc">
                                    <p align="center" style="font-weight: bold">Resultados
                                </th>
                ...
                <br>
                <a href="excel.php" class="btn btn-sm btn-primary" style="background-color:green">Descargar listado
                    completo</a>
                    <br>
                ...
                <br>
                <footer>
                    <div class="m-n2" style="position: center">
            ...
            <div class="card shadow-lg ">
                ...
                <div class="card-body pt-sm-3 pt-0">
                    ...
                    <div class="w-100 text-center">
                        ...
                        <center>
                            <a href="https://www.youtube.com/channel/UCuyLBtOJSpTiiEPWO701CZg"
                                class="btn btn-dark mb-0 me-2" target="_blank">
                                <i class="fab fa-youtube me-1" aria-hidden="true"></i> Twitter
                            </a>
                            <a href="https://es-la.facebook.com/franciscorochacolombia/" class="btn btn-dark mb-0 me-2"
                                target="_blank">
                            ...
                            <a href="https://www.instagram.com/franciscorocha_col/?hl=es-la"
                                class="btn btn-dark mb-0 me-2" target="_blank">
                                <i class="fab fa-instagram me-1" aria-hidden="true"></i> Instagram
                            </a>

                            <a href="https://co.linkedin.com/company/franciscorochacolombia"
                                class="btn btn-dark mb-0 me-2" target="_blank">
